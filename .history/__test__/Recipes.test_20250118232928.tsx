...
describe("Recipes Page", () => {
  ...
  test("renders recipe items correctly", async () => {
    ...
    expect(screen.getByAltText("Salad").getAttribute("src")).toContain(
      "/path/to/salad.jpg"
    );
    expect(screen.getByAltText("Pasta").getAttribute("src")).toContain(
      "/path/to/pasta.jpg"
    );
    expect(screen.getByAltText("Pizza").getAttribute("src")).toContain(
      "/path/to/pizza.jpg"
    );
