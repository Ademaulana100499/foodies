...
describe("Recipes Page", () => {
  ...
  test("renders recipe items correctly", async () => {
    ...
    // Debugging to check the rendered HTML structure
    screen.debug();

    // Verifying the description with a more flexible matcher
    expect(
      screen.getByText((content, element) =>
        element.textContent.includes("A healthy green salad")
      )
    ).toBeInTheDocument();
  });
