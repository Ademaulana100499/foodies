...
describe("getServerSideProps", () => {
  test("fetches data successfully", async () => {
    ...
    const mockContext = {
      params: { id: "1" }, // Mock the params object if needed
    };

    const response = await getServerSideProps(mockContext); // Pass the mockContext here
  ...
  test("handles API error gracefully", async () => {
    ...
    const mockContext = {
      params: { id: "1" }, // Mock the params object
    };
