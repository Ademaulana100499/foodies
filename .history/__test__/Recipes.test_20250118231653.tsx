...
// Define mock data globally for all tests
const mockData: Food[] = [
  {
    id: "1",
...
describe("getServerSideProps", () => {
  it("fetches food data and returns it as props", async () => {
    ...
    const context: GetServerSidePropsContext = {
      params: { id: "1" },
      req: {}, // Mock request object (can be empty or a mock if needed)
      res: {}, // Mock response object (can be empty or a mock if needed)
      query: {}, // Mock query object (can be empty or a mock if needed)
      resolvedUrl: "/recipes/1", // Mock resolved URL (can be any string or URL needed)
    };

    // Call getServerSideProps with the context, don't call it like a regular function
  ...
  it("returns empty data on error", async () => {
    ...
    const context: GetServerSidePropsContext = {
      ...
      resolvedUrl: "/recipes/1", // Mock resolved URL
    };
