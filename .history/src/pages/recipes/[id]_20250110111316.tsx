...
const RecipesDetail = ({ food }: FoodDetail) => {
  ...
  // Dummy steps in case there are no steps in the API
  const dummySteps = [
    "Step 1: Prepare all ingredients.",
    "Step 2: Heat the pan and add oil.",
    "Step 3: Cook the main ingredient until golden brown.",
    "Step 4: Add seasoning and cook for another 5 minutes.",
    "Step 5: Serve hot and enjoy your meal!",
  ];
