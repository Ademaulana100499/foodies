          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {data.map((item: Food) => (
              <div
                ...
                key={item.id}
                className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 hover:shadow-orange-500 transition-shadow duration-300"
              >
                <img
                  src={item.imageUrl}
                  alt={item.name}
