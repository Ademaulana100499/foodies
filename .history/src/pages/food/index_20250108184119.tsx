            ...
            {data.map((item: Food) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mt-2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos nam consectetur sit cupiditate maiores nostrum, reprehenderit a quo delectus explicabo exercitationem inventore similique ducimus ad, ea excepturi sed aliquam. Quae!</p>
                  <button
