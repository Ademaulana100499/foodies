...
const LoginPage = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-[url('https://www.burnaby.ca/sites/default/files/styles/rad_classic_1200w/public/acquiadam/2022-03/food%20systems%20project.jpg?h=c673cd1c&itok=67weI0aD')] bg-cover p-4">
      <div className="bg-white p-8 rounded-s-md shadow-2xl max-w-md w-full">
        <button
          onClick={handleBackClick}
          className="absolute top-4 left-4 p-3 bg-orange-500 text-white rounded-full hover:bg-orange-600 transition duration-300 flex items-center justify-center ">
