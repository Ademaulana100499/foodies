...
const LoginPage = () => {
  ...
  // Fungsi untuk navigasi kembali ke halaman sebelumnya atau halaman utama
  const handleBackClick = () => {
    router.push("/"); // Ganti dengan rute yang sesuai, bisa juga router.back() untuk kembali ke halaman sebelumnya
  };
    ...
    <div className="flex items-center justify-center h-screen bg-[url('https://www.burnaby.ca/sites/default/files/styles/rad_classic_1200w/public/acquiadam/2022-03/food%20systems%20project.jpg?h=c673cd1c&itok=67weI0aD')] bg-cover p-4">
      <div className="bg-white p-8 rounded-lg shadow-2xl max-w-md w-full">
        ...
        <button
          ...
          className="absolute top-4 left-4 text-white bg-gray-700 p-2 rounded-full hover:bg-gray-800 transition duration-300">
          &larr; Back
        </button>

        <h2 className="text-center text-4xl font-semibold text-orange-600 mb-10">
          Welcome to Foodies
        </h2>
