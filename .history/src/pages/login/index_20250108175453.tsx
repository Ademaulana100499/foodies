  ...
  return (
    <div className="flex items-center justify-center h-screen bg-[url('https://www.burnaby.ca/sites/default/files/styles/rad_classic_1200w/public/acquiadam/2022-03/food%20systems%20project.jpg?h=c673cd1c&itok=67weI0aD')] bg-cover p-4">
      <div className="bg-white p-8 rounded-lg shadow-2xl max-w-md w-full">
        ...
        <p className="text-center text-gray-500 text-base font-light leading-relaxed mb-8">
          Explore, share, and discover delicious recipes from all around the
          world. Log in to join our vibrant community and start your culinary
          journey today!
        </p>
        <input
          type="text"
