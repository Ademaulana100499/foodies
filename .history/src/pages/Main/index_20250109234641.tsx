...
const MainPage = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
    <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 transition-transform duration-500">
      <img
        src="https://source.unsplash.com/400x300/?food&sig=1"
        alt="Recipe"
    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 transition-transform duration-500">
      <img
        src="https://source.unsplash.com/400x300/?food&sig=2"
        alt="Recipe"
        className="w-full h-48 object-cover"
      />
      <div className="p-4">
    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 transition-transform duration-500">
      <img
        src="https://source.unsplash.com/400x300/?food&sig=3"
        alt="Recipe"
        className="w-full h-48 object-cover"
      />
      <div className="p-4">
