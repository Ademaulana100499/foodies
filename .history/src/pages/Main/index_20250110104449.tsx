    ...
    <div>
      ...
      <section id="recipes" className="py-16 px-8 md:px-16 bg-white">
        ...
        <div className="mt-8 text-center">
          <Link href="/recipes">
            <a className="inline-block bg-orange-500 text-white px-8 py-4 rounded-lg text-xl font-semibold hover:bg-orange-600 transition duration-300">
              Browse All Recipes
            </a>
          </Link>
        </div>
        <div className="mt-12 flex justify-center gap-8">
          <div className="bg-gray-200 p-6 rounded-lg shadow-lg w-48">
            <img
              src="https://source.unsplash.com/200x200/?salad"
              alt="Salad"
          ...
          <div className="bg-gray-200 p-6 rounded-lg shadow-lg w-48">
            <img
              src="https://source.unsplash.com/200x200/?dessert"
              alt="Dessert"
              className="w-full h-32 object-cover rounded-lg mb-4"
            />
            <h3 className="text-xl font-semibold text-gray-800">
          ...
          <div className="bg-gray-200 p-6 rounded-lg shadow-lg w-48">
            <img
              src="https://source.unsplash.com/200x200/?pasta"
              alt="Pasta"
              className="w-full h-32 object-cover rounded-lg mb-4"
            />
            <h3 className="text-xl font-semibold text-gray-800">
