...
const Navbar = () => {
    ...
    useEffect(() => {
      ...
      const handleLogout = () => {
        ...
        window.location.reload(); // Refresh halaman (opsional, jika ingin langsung update UI)
      };
    ...
    <nav className="bg-orange-500 shadow-lg fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:block">
          {token ? (
            <button onClick={handleLogout} className="bg-white text-orange-500 font-semibold py-2 px-4 rounded-lg hover:bg-orange-100 transition duration-300">
            Logout
          </button>
          ) : (
